...
`RISC0_DEV_MODE=1` (`scripts/lp0002-demo.sh`); the partial-approval restart-resume is
demonstrated (`scripts/lp0002-resume.sh` — `approval_count==1` survives a sequencer
